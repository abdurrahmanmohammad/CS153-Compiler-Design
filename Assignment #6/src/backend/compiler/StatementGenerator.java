...
public class StatementGenerator extends CodeGenerator
{
   ...
   public void emitIf(PascalParser.IfStatementContext ctx) {
    ...
    public void emitCase(PascalParser.CaseStatementContext ctx)
    {
        ...
        ctx.jumpTable = new TreeMap<>(); 
        
        //maps a branch's statement context to their jump label
        HashMap<PascalParser.StatementContext, Label> stmtLabelMap = new HashMap<>();
        ...
        for(PascalParser.CaseBranchContext branch : ctx.caseBranchList().caseBranch())
        {
            ...
            PascalParser.StatementContext stmtCtx = branch.statement();
            ...
            if(stmtCtx != null)
            {
                ...
                for(PascalParser.CaseConstantContext constCtx : branch.caseConstantList().caseConstant())
                {
        ...
        {
            PascalParser.StatementContext stmtContext = ctx.jumpTable.get(i);
        ...
        for(PascalParser.StatementContext stmtCtx : stmtLabelMap.keySet())
        {
     ...
     public void emitProcedureCall(PascalParser.ProcedureCallStatementContext ctx)
    {
    	...
    	SymtabEntry procedureEntry = ctx.procedureName().entry; 
                          ...
                          PascalParser.ArgumentListContext argListCtx)
    {
        ...
        if(argListCtx != null)
        {
            ...
            {
                PascalParser.ExpressionContext expCtx = argListCtx.argument(i).expression();
