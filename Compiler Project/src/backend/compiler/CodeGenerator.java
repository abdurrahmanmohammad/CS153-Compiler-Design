...
public class CodeGenerator
{
    ...
    public void emitStaticInitializer(ScopeEntry entry)
    {
    ...
    public void emitRoutineCloser(SixtyFortranParser.RoutineDefinitionContext ctx, boolean isStatic)
    {
        ...
        if(isStatic)
            emit(LIMIT_LOCALS, String.valueOf(ctx.routineScope.getNumLocals()));
        else
